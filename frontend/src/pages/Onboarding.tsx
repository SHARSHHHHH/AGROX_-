...
export default function Onboarding() {
  ...
  const save = async (advance = true) => {
    ...
    try {
      ...
      setStatus(s)
      // Tell dashboard widgets that the farm profile changed. They can
      // refetch their existing APIs without duplicating farm-state logic.
      window.dispatchEvent(new Event('farm-updated'))
