...
# Official district-level PM-KISAN data for Madhya Pradesh.
# Source: Government of India, Rajya Sabha Unstarred Question No. 2409,
# Annexure II, answered 13-03-2026; beneficiary counts are for the 21st
# instalment, data as on 05-03-2026. This replaces the old illustrative
# DistrictFunding rows in the admin district view.
MP_PMKISAN_SOURCE = (
    "Government of India, Rajya Sabha Unstarred Question No. 2409, "
    "Annexure II — PM-KISAN 21st instalment, as on 05-03-2026"
)
MP_PMKISAN_SOURCE_URL = "https://sansad.in/getFile/annex/270/AU2409_K32YjT.pdf?source=pqars"
MP_PMKISAN_21ST_BENEFICIARIES = {
    "Agar-Malwa": 93626, "Alirajpur": 82738, "Anuppur": 81962,
    "Ashoknagar": 128988, "Balaghat": 314588, "Barwani": 125144,
    "Betul": 234711, "Bhind": 185419, "Bhopal": 55134, "Burhanpur": 46789,
    "Chhatarpur": 247227, "Chhindwara": 211429, "Damoh": 173316,
    "Datia": 130284, "Dewas": 157700, "Dhar": 219197, "Dindori": 117590,
    "Guna": 167008, "Gwalior": 112258, "Harda": 59212, "Indore": 73923,
    "Jabalpur": 141147, "Jhabua": 124124, "Katni": 154530,
    "Khandwa (East Nimar)": 140806, "Khargone (West Nimar)": 185269,
    "Maihar": 69270, "Mandla": 139697, "Mandsaur": 201099, "Mauganj": 65856,
    "Morena": 223892, "Narmadapuram": 130532, "Narsimhapur": 138997,
    "Neemuch": 99663, "Niwari": 60997, "Pandhurna": 43717, "Panna": 151841,
    "Raisen": 156963, "Rajgarh": 234975, "Ratlam": 159009, "Rewa": 170686,
    "Sagar": 287941, "Satna": 143924, "Sehore": 162548, "Seoni": 237446,
    "Shahdol": 111308, "Shajapur": 138198, "Sheopur": 90840,
    "Shivpuri": 272257, "Sidhi": 129404, "Singrauli": 133810,
    "Tikamgarh": 161346, "Ujjain": 198280, "Umaria": 85053, "Vidisha": 218083,
}
MP_PMKISAN_DISTRICT_NAMES = list(MP_PMKISAN_21ST_BENEFICIARIES.keys())


# Verified district-level PM-KISAN datasets for states beyond Madhya Pradesh.
# These are kept separate from DistrictFunding demo rows.  Where Parliament
# publishes an actual amount disbursed, we display that amount; where only
# beneficiaries are published, the standard PM-KISAN instalment value is
# explicitly labelled as a transparent derivation.
MAHARASHTRA_PMKISAN_SOURCE = (
    "Government of India, Lok Sabha Unstarred Question No. 4344, Annexure-2 — "
    "PM-KISAN 20th instalment, Maharashtra, as on 04-08-2025"
)
MAHARASHTRA_PMKISAN_SOURCE_URL = "https://sansad.in/getFile/loksabhaquestions/annex/185/AU4344_Bfiq4m.pdf?source=pqals"
MAHARASHTRA_PMKISAN_20TH = {
    "Ahilyanagar": (548277, 113.06), "Akola": (187755, 38.64), "Amravati": (273626, 57.19),
    "Beed": (382085, 80.90), "Bhandara": (214796, 44.17), "Buldhana": (341819, 71.53),
    "Chandrapur": (245234, 50.24), "Chhatrapati Sambhajinagar": (345001, 70.33),
    "Dharashiv": (237673, 49.15), "Dhule": (157606, 33.28), "Gadchiroli": (151570, 31.06),
    "Gondia": (217970, 45.35), "Hingoli": (176726, 36.24), "Jalgaon": (395527, 84.61),
    "Jalna": (298655, 61.76), "Kolhapur": (476339, 100.28), "Latur": (271987, 55.61),
    "Nagpur": (177110, 37.30), "Nanded": (385773, 79.78), "Nandurbar": (104694, 21.75),
    "Nashik": (428800, 87.60), "Palghar": (103255, 22.04), "Parbhani": (250584, 51.36),
    "Pune": (438473, 89.55), "Raigad": (117005, 24.98), "Ratnagiri": (160226, 34.59),
    "Sangli": (387858, 79.14), "Satara": (446949, 94.53), "Sindhudurg": (122150, 25.37),
    "Solapur": (496707, 103.60), "Thane": (73228, 15.02), "Wardha": (130354, 27.16),
    "Washim": (167824, 34.95), "Yavatmal": (291865, 60.45),
}

RAJASTHAN_PMKISAN_SOURCE = (
    "Government of India, Lok Sabha Starred Question No. 27, Annexure-II — "
    "PM-KISAN 21st instalment in Rajasthan, amount released up to 25-11-2025"
)
RAJASTHAN_PMKISAN_SOURCE_URL = "https://sansad.in/getFile/loksabhaquestions/annex/186/AS27_1K0INz.pdf?source=pqals"
RAJASTHAN_PMKISAN_21ST = {
    "Ajmer": (170147, 34.03), "Alwar": (140237, 28.05), "Balotra": (124367, 24.87),
    "Banswara": (187609, 37.52), "Baran": (169629, 33.93), "Barmer": (217386, 43.48),
    "Beawar": (125357, 25.07), "Bharatpur": (144829, 28.97), "Bhilwara": (310029, 62.01),
    "Bikaner": (178816, 35.76), "Bundi": (142619, 28.52), "Chittorgarh": (212985, 42.60),
    "Churu": (220887, 44.18), "Dausa": (149367, 29.87), "Deeg": (97651, 19.53),
    "Dholpur": (142261, 28.45), "Didwana-Kuchaman": (148854, 29.77), "Dungarpur": (152600, 30.52),
    "Ganganagar": (145104, 29.02), "Hanumangarh": (191371, 38.27), "Jaipur": (299026, 59.81),
    "Jaisalmer": (61001, 12.20), "Jalore": (200758, 40.15), "Jhalawar": (200574, 40.11),
    "Jhunjhunu": (215893, 43.18), "Jodhpur": (217967, 43.59), "Karauli": (137276, 27.46),
    "Khairthal-Tijara": (65263, 13.05), "Kota": (119032, 23.81), "Kotputli-Behror": (110942, 22.19),
    "Nagaur": (183113, 36.62), "Pali": (150521, 30.10), "Phalodi": (80384, 16.08),
    "Pratapgarh": (79494, 15.90), "Rajsamand": (139204, 27.84), "Salumbar": (64347, 12.87),
    "Sawai Madhopur": (129327, 25.87), "Sikar": (230956, 46.19), "Sirohi": (78889, 15.78),
    "Tonk": (222099, 44.42), "Udaipur": (172241, 34.45),
}

TAMIL_NADU_PMKISAN_SOURCE = (
    "Government of India, Lok Sabha Unstarred Question No. 419, Annexure — "
    "PM-KISAN 21st instalment, Tamil Nadu, amount disbursed up to 25-11-2025"
)
TAMIL_NADU_PMKISAN_SOURCE_URL = "https://sansad.in/getFile/loksabhaquestions/annex/186/AU419_srAZOJ.pdf?source=pqals"
# Parliament's Annexure reports district-wise amount disbursed; beneficiary
# counts are not published in that table, so amount is the primary metric.
TAMIL_NADU_PMKISAN_21ST_AMOUNT = {
    "Ariyalur": 13.34, "Chengalpattu": 5.17, "Chennai": 0.01, "Coimbatore": 8.95,
    "Cuddalore": 15.09, "Dharmapuri": 20.03, "Dindigul": 14.56, "Erode": 14.44,
    "Kallakurichi": 14.69, "Kancheepuram": 4.26, "Kanniyakumari": 23.84, "Karur": 9.66,
    "Krishnagiri": 17.07, "Madurai": 10.97, "Mayiladuthurai": 2.60, "Nagapattinam": 4.45,
    "Namakkal": 12.81, "Perambalur": 10.29, "Pudukkottai": 15.88, "Ramanathapuram": 11.22,
    "Ranipet": 7.96, "Salem": 23.13, "Sivaganga": 11.38, "Tenkasi": 7.54,
    "Thanjavur": 12.48, "The Nilgiris": 4.08, "Theni": 5.21, "Thiruvallur": 7.97,
    "Thiruvarur": 7.68, "Thoothukkudi": 9.29, "Tiruchirappalli": 19.93, "Tirunelveli": 5.82,
    "Tirupathur": 7.77, "Tiruppur": 12.21, "Tiruvannamalai": 27.79, "Vellore": 7.00,
    "Viluppuram": 16.40, "Virudhunagar": 9.77,
}

VERIFIED_DISTRICT_DATASETS = {
    "Madhya Pradesh": {
        "scheme": "PM-KISAN", "installment": "21st", "date": "05-03-2026",
        "metric": "Support derived from official beneficiaries",
        "source": MP_PMKISAN_SOURCE, "source_url": MP_PMKISAN_SOURCE_URL,
        "published_total_cr": round(sum(MP_PMKISAN_21ST_BENEFICIARIES.values()) * 2000 / 10_000_000, 2),
    },
    "Maharashtra": {
        "scheme": "PM-KISAN", "installment": "20th", "date": "04-08-2025",
        "metric": "Amount actually disbursed",
        "source": MAHARASHTRA_PMKISAN_SOURCE, "source_url": MAHARASHTRA_PMKISAN_SOURCE_URL,
        "published_total_cr": 1912.57,
    },
    "Rajasthan": {
        "scheme": "PM-KISAN", "installment": "21st", "date": "25-11-2025",
        "metric": "Amount actually disbursed",
        "source": RAJASTHAN_PMKISAN_SOURCE, "source_url": RAJASTHAN_PMKISAN_SOURCE_URL,
        "published_total_cr": 1306.08,
    },
    "Tamil Nadu": {
        "scheme": "PM-KISAN", "installment": "21st", "date": "25-11-2025",
        "metric": "Amount actually disbursed",
        "source": TAMIL_NADU_PMKISAN_SOURCE, "source_url": TAMIL_NADU_PMKISAN_SOURCE_URL,
        "published_total_cr": 432.74,
    },
}
...
def district_funding_list(db: Session, state: str, financial_year: str = CURRENT_FY,
    ...
    """Verified district-level PM-KISAN support where Parliament publishes
    district data. Never falls back to illustrative district funding rows for
    the interactive admin page; states without verified district data return
    an empty list so the UI cannot accidentally present demo money as real.
    """
    if scheme_id is None and state in VERIFIED_DISTRICT_DATASETS:
        meta = VERIFIED_DISTRICT_DATASETS[state]
        out = []
        if state == "Madhya Pradesh":
            for district, beneficiaries in MP_PMKISAN_21ST_BENEFICIARIES.items():
                amount = round(beneficiaries * 2000 / 10_000_000, 2)
                out.append({
                    "district": district, "beneficiaries": beneficiaries,
                    "amount_cr": amount, "amount_type": "derived_support",
                    "installment": meta["installment"], "data_date": meta["date"],
                    "data_status": "VERIFIED", "source": meta["source"],
                    "source_url": meta["source_url"], "last_updated": meta["date"],
                })
        elif state == "Maharashtra":
            for district, (beneficiaries, amount) in MAHARASHTRA_PMKISAN_20TH.items():
                out.append({
                    "district": district, "beneficiaries": beneficiaries,
                    "amount_cr": amount, "amount_type": "disbursed",
                    "installment": meta["installment"], "data_date": meta["date"],
                    "data_status": "VERIFIED", "source": meta["source"],
                    "source_url": meta["source_url"], "last_updated": meta["date"],
                })
        elif state == "Rajasthan":
            for district, (beneficiaries, amount) in RAJASTHAN_PMKISAN_21ST.items():
                out.append({
                    "district": district, "beneficiaries": beneficiaries,
                    "amount_cr": amount, "amount_type": "disbursed",
                    "installment": meta["installment"], "data_date": meta["date"],
            ...
            for district, amount in TAMIL_NADU_PMKISAN_21ST_AMOUNT.items():
                out.append({
                    "district": district, "beneficiaries": None,
                    "amount_cr": amount, "amount_type": "disbursed",
                    "installment": meta["installment"], "data_date": meta["date"],
                    "data_status": "VERIFIED", "source": meta["source"],
                    "source_url": meta["source_url"], "last_updated": meta["date"],
        ...
        if sort_by in ("beneficiaries_asc", "allocated_asc"):
            out.sort(key=lambda x: (x["beneficiaries"] is None, x["beneficiaries"] or x["amount_cr"]))
        elif sort_by in ("amount", "allocated"):
            out.sort(key=lambda x: -x["amount_cr"])
        else:
            out.sort(key=lambda x: (x["beneficiaries"] is None, -(x["beneficiaries"] or 0), -x["amount_cr"]))
        return out

    # For a specific scheme drill-down, retain the underlying database rows.
    # The verified all-state page above is deliberately scheme-level PM-KISAN
    # data, not a fabricated agriculture-budget allocation.
...
def district_funding_detail(db: Session, state: str, district: str,
    ...
    """District detail using the same verified dataset as the list page."""
    if state in VERIFIED_DISTRICT_DATASETS:
        rows = district_funding_list(db, state, financial_year, None, "beneficiaries")
        row = next((r for r in rows if r["district"].lower() == district.lower()), None)
        if row:
            return {
                "state": state, "district": row["district"], "financial_year": financial_year,
                "operational": {"health_score": None},
                "funding": {
                    "beneficiaries": row.get("beneficiaries"),
                    "amount_cr": row.get("amount_cr"),
                    "amount_type": row.get("amount_type"),
                    "installment": row.get("installment"),
                    "data_date": row.get("data_date"),
                    "data_status": "VERIFIED", "source": row.get("source"),
                    "source_url": row.get("source_url"), "last_updated": row.get("last_updated"),
                },
                "scheme_performance": [],
                "coverage_gap": {"farmers": None, "beneficiaries": row.get("beneficiaries"),
                                 "coverage_pct": None, "status": "Official PM-KISAN district data; AGROX registration counts are not used for verification.",
                                 "recommended_action": None},
                "satellite": {"available": False, "reason": "Satellite metrics are kept separate from official funding data."},
            }
    ...
    return {
        ...
        "funding": {
            ...
            "amount_cr": total_row.allocated_cr if total_row else None,
            "amount_type": "database_row",
